...
`].filter(Uo).join(`
`)),d=_h(d),d=fx(d,i),d=dx(d,i),h=_h(h),h=fx(h,i),h=dx(h,i),d=hx(d),h=hx(h),i.isRawShaderMaterial!==!0&&(z=`#version 300 es
...
`)+`
`+v);const L=z+y+d,I=z+v+h,X=lx(l,l.VERTEX_SHADER,L),O=lx(l,l.FRAGMENT_SHADER,I);l.attachShader(C,X),l.attachShader(C,O),i.index0AttributeName!==void 0?l.bindAttribLocation(C,0,i.index0AttributeName):i.morphTargets===!0&&l.bindAttribLocation(C,0,"position"),l.linkProgram(C);function N(j){if(o.debug.checkShaderErrors){const it=l.getProgramInfoLog(C)||"",ut=l.getShaderInfoLog(X)||"",gt=l.getShaderInfoLog(O)||"",pt=it.trim(),B=ut.trim(),Z=gt.trim();let Q=!0,bt=!0;if(l.getProgramParameter(C,l.LINK_STATUS)===!1)if(Q=!1,typeof o.debug.onShaderError=="function")o.debug.onShaderError(l,C,X,O);else{const St=cx(l,X,"vertex"),S=cx(l,O,"fragment");an("THREE.WebGLProgram: Shader Error "+l.getError()+" - VALIDATE_STATUS "+l.getProgramParameter(C,l.VALIDATE_STATUS)+`
